...
export const GUIAS: Guia[] = [
  {
    ...
    bloques: [
      ...
      { tipo: 'p', texto: 'En Depil Ec, podemos ayudarte, somos líderes en depilación permanente mediante luz pulsada intensa y en cosmetología avanzada. Te invitamos a nuestros locales Depil Ec en Quito y todas nuestras sedes al rededor del Ecuador para recibir una asesoría y diagnóstico completamente gratis.' },
      ...
      { tipo: 'p', texto: 'En Depil Ec trabajamos con la tecnología de luz pulsada intensa o IPL, un método de depilación progresivo, que promueve la producción de colágeno en la piel, estimulando al poro y eliminando la aparición del vello. Contamos con protocolos europeos y tecnología de última generación, para ofrecer los mejores resultados.' },
      { tipo: 'h2', texto: 'Más beneficios de la depilación definitiva' },
      { tipo: 'p', texto: 'No sirve solamente para eliminar el vello, sino que también contribuye a mejorar la textura y la elasticidad de la piel. La luz pulsada intensa genera una activación del colágeno y la elastina que brinda mayor suavidad a la piel. También sirve para aclarar zonas manchadas como las axilas, que suelen ponerse de un color oscuro.' },
      ...
      { tipo: 'p', texto: 'En Vellísimo Ecuador contamos una tecnología de refrigeración que nos permite contrastar el calor de la onda al calentarse el folículo, que nos ayuda a combatir la sensación de dolor.' },
